...
public class KeyboardInputs : MonoBehaviour
{
    ...
    private void Start()
    {
        GameObject.Find(StaticObjects.GetMainObjects().PauseMenuControlsOptionsButtons).GetComponent<ControlsSchemeSettings>().OnKeyboardControlChanged += SetUsingArrowControlsScheme;
